 ...
 */
public class BitMatrix extends foal.PersistentObject {
 ...
 */
public boolean forEachCoordinateInState(boolean state, final foal.function.IntIntProcedure procedure) {
	/*
