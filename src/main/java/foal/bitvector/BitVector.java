 ...
 */
public class BitVector extends foal.PersistentObject {
	/*
	...
	private class IndexProcedure implements foal.function.IntProcedure {
 ...
 */
public boolean forEachIndexFromToInState(int from, int to, boolean state, foal.function.IntProcedure procedure) {
	/*
