...
import foal.list.AbstractIntList;
/**
 * Adapter that permits an {@link foal.list.AbstractIntList} to be viewed and treated as a JDK 1.2 {@link java.util.AbstractList}.
 ...
 */
protected static int value(Number element) {
