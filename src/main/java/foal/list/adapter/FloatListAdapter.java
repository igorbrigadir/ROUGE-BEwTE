...
import foal.list.AbstractFloatList;
/**
 * Adapter that permits an {@link foal.list.AbstractFloatList} to be viewed and treated as a JDK 1.2 {@link java.util.AbstractList}.
 ...
 */
protected static float value(Number element) {
