...
public int binarySearchFromTo(double key, int from, int to) {
	return foal.Sorting.binarySearchFromTo(this.elements,key,from,to);
}
/**
...
public void ensureCapacity(int minCapacity) {
	elements = foal.Arrays.ensureCapacity(elements,minCapacity);
}
/**
...
public void trimToSize() {
	elements = foal.Arrays.trimToCapacity(elements,size());
}
}
