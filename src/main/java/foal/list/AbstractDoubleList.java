...
*/
public abstract class AbstractDoubleList extends AbstractList implements foal.buffer.DoubleBufferConsumer {
	/**
...
public void mergeSortFromTo(int from, int to) {
	...
	foal.Sorting.mergeSort(myElements, from, to+1);
	elements(myElements);
	setSizeRaw(mySize);
}
/**
...
public void mergeSortFromTo(int from, int to, DoubleComparator c) {
	...
	double[] myElements = elements();
	foal.Sorting.mergeSort(myElements, from, to+1, c);
	elements(myElements);
	setSizeRaw(mySize);
}
/**
...
public void quickSortFromTo(int from, int to, DoubleComparator c) {
	...
	double[] myElements = elements();
	foal.Sorting.quickSort(myElements, from, to+1,c);
	elements(myElements);
	setSizeRaw(mySize);
}
/**
