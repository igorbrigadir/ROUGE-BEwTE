...
import foal.matrix.impl.AbstractMatrix1D;
/**
...
@see cern.jet.math.Functions
*/
public double aggregate(DoubleMatrix1D other, foal.function.DoubleDoubleFunction aggr, foal.function.DoubleDoubleFunction f) {
	checkSize(other);
	if (size==0) return Double.NaN;
...
@see cern.jet.math.Functions
*/
public DoubleMatrix1D assign(foal.function.DoubleFunction function) {
	for (int i=size; --i >= 0; ) {
...
@see cern.jet.math.Functions
*/
public DoubleMatrix1D assign(DoubleMatrix1D y, foal.function.DoubleDoubleFunction function) {
	checkSize(y);
	for (int i=size; --i >= 0; ) {
...
@see cern.jet.math.Functions
*/
public DoubleMatrix1D assign(DoubleMatrix1D y, foal.function.DoubleDoubleFunction function, foal.list.IntArrayList nonZeroIndexes) {
	checkSize(y);
...
public boolean equals(Object obj) {
	...
	return foal.matrix.linalg.Property.DEFAULT.equals(this,(DoubleMatrix1D) obj);
}
/**
...
@return the new view.
*/
public DoubleMatrix1D viewSelection(foal.function.DoubleProcedure condition) {
...
For further information, see {@link foal.matrix.doublealgo.Sorting#sort(DoubleMatrix1D)}.
For more advanced sorting functionality, see {@link foal.matrix.doublealgo.Sorting}.
@return a new sorted vector (matrix) view.
*/
public DoubleMatrix1D viewSorted() {
	return foal.matrix.doublealgo.Sorting.mergeSort.sort(this);
}
/**
