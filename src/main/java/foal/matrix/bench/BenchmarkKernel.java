...
public static String systemInfo() {
	...
	// build string matrix
	foal.matrix.ObjectMatrix2D matrix = new foal.matrix.impl.DenseObjectMatrix2D(properties.length,2);
	...
	// format matrix
	foal.matrix.objectalgo.Formatter formatter = new foal.matrix.objectalgo.Formatter();
