...
import foal.matrix.impl.AbstractFormatter;
import foal.matrix.impl.AbstractMatrix1D;
import foal.matrix.impl.AbstractMatrix2D;
import foal.matrix.impl.Former;
/** 
Flexible, well human readable matrix print formatting.
Each cell is converted using {@link Object#toString()}.
For examples see {@link foal.matrix.doublealgo.Formatter doublealgo.Formatter} which is just the same except that it operates on doubles.
...
public String toTitleString(ObjectMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName, String columnAxisName, String title) {
	...
	foal.matrix.ObjectMatrix2D titleMatrix = matrix.like(height, width);
