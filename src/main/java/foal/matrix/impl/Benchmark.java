...
public static void benchmark(int runs, int size, String kind, boolean print, int initialCapacity, double minLoadFactor, double maxLoadFactor, double percentNonZero) {
	...
	foal.Timer timer1 = new foal.Timer();
	foal.Timer timer2 = new foal.Timer();
	foal.Timer timer3 = new foal.Timer();
	foal.Timer timer4 = new foal.Timer();
	foal.Timer timer5 = new foal.Timer();
	foal.Timer timer6 = new foal.Timer();

	DoubleMatrix2D  matrix = null;
	if (kind.equals("sparse")) matrix = new SparseDoubleMatrix2D(size,size,initialCapacity,minLoadFactor,maxLoadFactor);
	else if (kind.equals("dense")) matrix = foal.matrix.DoubleFactory2D.dense.make(size,size);
