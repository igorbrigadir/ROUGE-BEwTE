...
*/
public ObjectMatrix2D assign(foal.function.ObjectFunction function) {
...
@see cern.jet.math.Functions
*/
public ObjectMatrix2D assign(ObjectMatrix2D y, foal.function.ObjectObjectFunction function) {
	// overriden for performance only
