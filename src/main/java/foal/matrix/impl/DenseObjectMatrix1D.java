...
*/
public ObjectMatrix1D assign(foal.function.ObjectFunction function) {
	int s=stride;
	int i=index(0);
...
@see cern.jet.math.Functions
*/
public ObjectMatrix1D assign(ObjectMatrix1D y, foal.function.ObjectObjectFunction function) {
	// overriden for performance only
