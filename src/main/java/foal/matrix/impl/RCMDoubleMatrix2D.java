 ...
 */
protected void zMult(final DoubleMatrix1D y, final DoubleMatrix1D z, foal.list.IntArrayList nonZeroIndexes, DoubleMatrix1D[] allRows, final double alpha, final double beta) {
