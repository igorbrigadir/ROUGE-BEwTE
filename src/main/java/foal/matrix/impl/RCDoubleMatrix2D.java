...
<ul>
<li>We use a {@link foal.list.IntArrayList} and {@link foal.list.DoubleArrayList} to hold the column indexes and nonzero values, respectively. 
...
Method {@link #assign(DoubleMatrix2D,foal.function.DoubleDoubleFunction)} does just that if you supply {@link cern.jet.math.Functions#plusMult} as argument.
...
public DoubleMatrix2D assign(final foal.function.DoubleFunction function) {
