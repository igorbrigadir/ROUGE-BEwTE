...
<li>{@link #assign(DoubleMatrix2D,foal.function.DoubleFunction) assign(A,function)} (generalized matrix scaling/transform): Strong speedup only for expensive functions like logarithm, sin, etc.</li>
<li>{@link #assign(DoubleMatrix2D,DoubleMatrix2D,foal.function.DoubleDoubleFunction) assign(A,B,function)} (generalized matrix scaling/transform): Strong speedup only for expensive functions like pow etc.</li>
</ul>
...
public void assign(DoubleMatrix2D A, final foal.function.DoubleFunction function) {
	run(A,false,
...
public void assign(DoubleMatrix2D A, DoubleMatrix2D B, final foal.function.DoubleDoubleFunction function) {
	run(A,B,false,
		new Matrix2DMatrix2DFunction() {
			public double apply(DoubleMatrix2D AA, DoubleMatrix2D BB) {
