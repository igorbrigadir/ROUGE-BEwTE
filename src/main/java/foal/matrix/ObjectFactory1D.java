...
import foal.matrix.impl.DenseObjectMatrix1D;
import foal.matrix.impl.SparseObjectMatrix1D;
/**
...
*/
public class ObjectFactory1D<T> extends foal.PersistentObject {
	/**
 ...
 * @return a new matrix.
 */
public ObjectMatrix1D make(foal.list.ObjectArrayList values) {
 ...
 * @return a new list.
 */
public foal.list.ObjectArrayList toList(ObjectMatrix1D values) {
	int size = values.size();
	foal.list.ObjectArrayList list = new foal.list.ObjectArrayList(size);
	list.setSize(size);
