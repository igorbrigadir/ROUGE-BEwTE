...
import foal.matrix.impl.SparseDoubleMatrix1D;
/**
...
*/
public class DoubleFactory1D extends foal.PersistentObject {
	/**
 ...
 * @return a new matrix.
 */
public DoubleMatrix1D make(foal.list.AbstractDoubleList values) {
 ...
 * @return a new list.
 */
public foal.list.DoubleArrayList toList(DoubleMatrix1D values) {
	int size = values.size();
	foal.list.DoubleArrayList list = new foal.list.DoubleArrayList(size);
	list.setSize(size);
