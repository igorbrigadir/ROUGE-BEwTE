...
import foal.matrix.DoubleMatrix2DProcedure;
import foal.matrix.DoubleMatrix3D;
import foal.matrix.DoubleMatrix3DProcedure;
/**
...
*/
public static int stencil27(DoubleMatrix3D A, foal.function.Double27Function function, int maxIterations, DoubleMatrix3DProcedure hasConverged, int convergenceIterations) {
...
@return the number of iterations actually executed. 
*/
public static int stencil9(DoubleMatrix2D A, foal.function.Double9Function function, int maxIterations, DoubleMatrix2DProcedure hasConverged, int convergenceIterations) {
