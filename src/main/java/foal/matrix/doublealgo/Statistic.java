 ...
 */
abstract public double apply(foal.matrix.DoubleMatrix1D x, foal.matrix.DoubleMatrix1D y);
}
...
public static DoubleMatrix2D covariance(DoubleMatrix2D matrix) {
	...
	DoubleMatrix2D covariance = new foal.matrix.impl.DenseDoubleMatrix2D(columns,columns);
...
public static DoubleMatrix2D distance(DoubleMatrix2D matrix, VectorVectorFunction distanceFunction) {
	int columns = matrix.columns();
	DoubleMatrix2D distance = new foal.matrix.impl.DenseDoubleMatrix2D(columns,columns);
