...
*/
public class LongIntHashMap extends AbstractLongIntMap {
	 /**
	 * The hash table keys.
	 * @serial
	 */
 ...
 */
public LongIntHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
...
@Override
public Object clone() {
	LongIntHashMap copy = (LongIntHashMap) super.clone();
