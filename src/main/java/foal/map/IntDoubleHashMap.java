...
import foal.function.IntDoubleProcedure;
...
*/
public class IntDoubleHashMap extends AbstractIntDoubleMap {
 ...
 */
public IntDoubleHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
...
*/
@Override
public void assign(foal.function.DoubleFunction function) {
...
public void assign(AbstractIntDoubleMap other) {
	if (!(other instanceof IntDoubleHashMap)) {
		super.assign(other);
		return;
	}
	IntDoubleHashMap source = (IntDoubleHashMap) other;
	IntDoubleHashMap copy = (IntDoubleHashMap) source.copy();
...
@Override
public Object clone() {
	IntDoubleHashMap copy = (IntDoubleHashMap) super.clone();
