...
import foal.function.IntIntProcedure;
import foal.function.IntProcedure;
import foal.function.IntShortProcedure;
import foal.list.IntArrayList;
import foal.list.ShortArrayList;
/**
...
*/
/* Note: This class is a modified version of AbstractIntIntMap */
public abstract class AbstractIntShortMap extends AbstractMap {
	//public static int hashCollisions = 0; // for debug only
/**
 * Makes this class non instantiable, but still let's others inherit from it.
 */
protected AbstractIntShortMap() {}
/**
 ...
 */
public AbstractIntIntMap copy() throws CloneNotSupportedException {
...
public boolean equals(Object obj) {
	...
	if (!(obj instanceof AbstractIntShortMap)) return false;
 ...
 * @param valueList the list to be filled with values, can have any size.
 */
/*public void pairsSortedByValue(final IntArrayList keyList, final ShortArrayList valueList) {
	keys(keyList);
	values(valueList);
