...
import foal.function.DoubleIntProcedure;
...
*/
public class DoubleIntHashMap extends AbstractDoubleIntMap {
	 /**
	 * The hash table keys.
	 * @serial
	 */
 ...
 */
public DoubleIntHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
...
@Override
public Object clone() {
	DoubleIntHashMap copy = (DoubleIntHashMap) super.clone();
