...
*/
public class IntIntHashMap extends AbstractIntIntMap {
	 /**
	 * The hash table keys.
	 * @serial
	 */
 ...
 */
public IntIntHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
...
@Override
public Object clone() {
	IntIntHashMap copy = (IntIntHashMap) super.clone();
