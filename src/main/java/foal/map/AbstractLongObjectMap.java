...
import foal.function.LongObjectProcedure;
import foal.function.LongProcedure;
...
*/
public abstract class AbstractLongObjectMap<T> extends AbstractMap {
...
public boolean containsValue(final T value) {
	return ! forEachPair( 
		new LongObjectProcedure<T>() {
			public boolean apply(long iterKey, T iterValue) {
 ...
 */
public AbstractLongObjectMap<T> copy() throws CloneNotSupportedException {
 ...
 */
public long keyOf(final T value) {
...
*/
public void pairsMatching(final LongObjectProcedure<T> condition, final LongArrayList keyList, final ObjectArrayList<T> valueList) {
	keyList.clear();
	valueList.clear();
