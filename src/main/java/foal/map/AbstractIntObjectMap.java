...
import foal.function.IntObjectProcedure;
import foal.function.IntProcedure;
...
*/
public abstract class AbstractIntObjectMap<T> extends AbstractMap {
 ...
 */
public AbstractIntObjectMap<T> copy() throws CloneNotSupportedException {
...
public boolean equals(Object obj) {
	...
	final AbstractIntObjectMap<T> other = (AbstractIntObjectMap<T>) obj;
 ...
 */
public int keyOf(final T value) {
	final int[] foundKey = new int[1];
	boolean notFound = forEachPair(
		new IntObjectProcedure<T>() {
			public boolean apply(int iterKey, T iterValue) {
...
public void keysSortedByValue(final IntArrayList keyList) {
	pairsSortedByValue(keyList, new ObjectArrayList<T>(size()));
}
/**
...
<br>
<pre>
IntObjectProcedure<T> condition = new IntObjectProcedure<T>() { // match even keys only
...
*/
public void pairsMatching(final IntObjectProcedure<T> condition, final IntArrayList keyList, final ObjectArrayList<T> valueList) {
	keyList.clear();
	valueList.clear();
...
public void pairsSortedByValue(final IntArrayList keyList, final ObjectArrayList<T> valueList) {
	...
	foal.GenericSorting.quickSort(0,keyList.size(),comp,swapper);
}
/**
