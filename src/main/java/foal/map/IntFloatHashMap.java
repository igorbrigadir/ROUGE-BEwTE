...
import foal.function.FloatFunction;
import foal.function.IntFloatProcedure;
import foal.function.IntProcedure;
import foal.list.ByteArrayList;
import foal.list.FloatArrayList;
...
*/
public class IntFloatHashMap extends AbstractIntFloatMap {
 ...
 */
public IntFloatHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
...
*/
@Override
public void assign(FloatFunction function) {
	// specialization for speed
	Object o = function;
	if (o instanceof Mult) { // x[i] = mult*x[i]
		double multiplicator = ((Mult)o).multiplicator;
...
public void assign(AbstractIntFloatMap other) {
	if (!(other instanceof IntFloatHashMap)) {
		super.assign(other);
		return;
	}
	IntFloatHashMap source = (IntFloatHashMap) other;
	IntFloatHashMap copy = (IntFloatHashMap) source.copy();
...
@Override
public Object clone() {
	IntFloatHashMap copy = (IntFloatHashMap) super.clone();
