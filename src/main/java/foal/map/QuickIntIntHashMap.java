...
*/
class QuickIntIntHashMap extends IntIntHashMap {
	public int totalProbesSaved = 0; // benchmark only
/**
 * Constructs an empty map with default capacity and default load factors.
 */
public QuickIntIntHashMap() {
 ...
 *             than zero.
 */
public QuickIntIntHashMap(int initialCapacity) {
 ...
 */
public QuickIntIntHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
