...
/**
 * Feature extractiuon rule that just determines if the input token is capitalized or not
 *
 */
public class IsCapitalizedFER extends AbstractFeatureRule {
