...
/**
 * Returns the possessor of the syntactic governor of a word
 *
 */
public class PossessorOfSyntacticGovernorRule extends AbstractWordFindingRule {
					...
					if(headToken != null) {
						...
						if(children != null) {
							for(Arc child : children) {
								if(child.getDependency().equals(ParseConstants.POSSESSOR_DEP)) {
