...
import foal.function.DoubleDoubleFunction;
import foal.function.DoubleDoubleProcedure;
import foal.function.DoubleFunction;
import foal.function.DoubleProcedure;
...
<p>Unary functions are of type {@link foal.function.DoubleFunction}, binary functions 
  of type {@link foal.function.DoubleDoubleFunction}. All can be retrieved via <tt>public 
  static final</tt> variables named after the function. 
Unary predicates are of type {@link foal.function.DoubleProcedure}, binary predicates 
  of type {@link foal.function.DoubleDoubleProcedure}. All can be retrieved via <tt>public 
...
public static void demo2(int size) {
	...
	// emptyLoop
	foal.Timer emptyLoop = new foal.Timer().start();
	a = 0; b = 0;
	double sum = 0;
	for (int i=size; --i >= 0; ) {
		sum += a;
