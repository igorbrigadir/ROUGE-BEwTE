...
import foal.list.BooleanArrayList;
/**
 ...
 */
public class RandomSamplingAssistant extends foal.PersistentObject {
...
public static void test(long n, long N) {
	...
	foal.list.LongArrayList sample = new foal.list.LongArrayList((int)n);
