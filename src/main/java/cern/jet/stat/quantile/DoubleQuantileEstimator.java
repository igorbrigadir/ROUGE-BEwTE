...
abstract class DoubleQuantileEstimator extends foal.PersistentObject implements DoubleQuantileFinder {
 ...
 */
public boolean forEach(foal.function.DoubleProcedure procedure) {
